...
const SearchBar = () => {
    ...
    if (isSearchOpen) {
      return (
        <div className="fixed top-0 left-0 h-screen w-screen z-[1000] flex flex-col">
          <div className="bg-white h-[70px] p-[23px] flex items-center gap-[12px] w-full">
            ...
            <div className="rounded-[8px] p-[10px] flex items-center gap-[10px] dark:bg-bg-black bg-bg-light flex-grow">
              ...
              <input
                ...
                className="outline-none border-none flex-grow bg-transparent text-xs"
              />
            </div>
          </div>
  ...
  return (
    <div className="rounded-[8px] p-[10px] flex items-center gap-[10px] dark:bg-bg-black bg-bg-light">
      <SearchIcon />
      <input
        onChange={onSearchInput}
        value={searchText}
        placeholder="Search Property, Customer etc"
        className="outline-none border-none flex-grow bg-transparent text-xs min-w-[400px]"
      />
    </div>
  );
};
