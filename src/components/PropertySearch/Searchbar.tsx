  ...
  return (
    <>
      <div
        onFocus={focus}
        onBlur={blur}
        className={`flex-grow md:max-w-[450px] cursor-pointer bg-bg-light dark:bg-bg-dark rounded-[10px] px-[8px] py-[6px] flex items-center gap-[8px] border ${!focused ? 'border-bg-light dark:border-bg-dark' : 'border-primary'}`}
      >
        <Search color="inherit" />
        <input
          className="placeholder-secondary-light dark:placeholder-secondary-dark flex-grow border-none bg-transparent outline-none"
